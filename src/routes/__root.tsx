...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Multimodal Search" },
      { property: "og:description", content: "Search across text, images, and audio with Gemini embeddings." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Multimodal Search" },
      { name: "twitter:description", content: "Search across text, images, and audio with Gemini embeddings." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8089b05a-e27f-43bf-ab32-3a356f774b7f/id-preview-41d2133a--9bd350d8-eb9b-4ff1-99d6-dae2ca0d10e8.lovable.app-1777302476408.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8089b05a-e27f-43bf-ab32-3a356f774b7f/id-preview-41d2133a--9bd350d8-eb9b-4ff1-99d6-dae2ca0d10e8.lovable.app-1777302476408.png" },
